...
- Map fan RPM/duty/curve + cooler-boost + charge-threshold EC offsets (firmware RE + live EC diff).
- Reverse **MSI Center (Windows)** for authoritative fan-curve/cooler-boost register encodings.
